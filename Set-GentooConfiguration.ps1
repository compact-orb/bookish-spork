...
Remove-Item -Path /mnt/gentoo/etc/kernel/config.d, /mnt/gentoo/etc/portage/binrepos.conf, /mnt/gentoo/etc/portage/env, /mnt/gentoo/etc/portage/package.env, /mnt/gentoo/etc/portage/package.use -Recurse -Force -ErrorAction SilentlyContinue
...
BINPKG_COMPRESS_FLAGS="-22 -T8 --ultra"
'@
}
